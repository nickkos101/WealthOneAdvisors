        ...
        <section class="site-options">
            <div class="col-wrap">
                <div class="column third">
                    <div class="options-square taligncenter" onclick="location.href='unit_01.htm'">
                        <h1>Who We Are</h1>
                        <p>Let's say some really cool things here</p>
                        <div class="btn">Learn More</div>
                    </div>
                </div>
                <div class="column third">
                    <div class="options-square taligncenter no-side-border" onclick="location.href='unit_01.htm'">
                ...
                <section class="process-panel">
                    <div class="city-bg">
                        ...
                        <div class="col-wrap">
                            ...
                            <div class="column third video-piece">
                                <div class="video-col taligncenter">
                                    <div class="videoTitleHeader">Elite Advisor</div>
                                    <div class="videoImage">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/video_1.jpg" alt="Elite Advisor" />
                            ...
                            <div class="container blog-preview">
                                <div class="col-wrap">
                                    <div class="column third">
                                        <div class="blog-box">
                                            <h2 class="blog-title">WealthOne Advisors Capital Markets Outlook</h1>
                                                <p class="blog-summary">Read our quarterly letter to clients</p>
